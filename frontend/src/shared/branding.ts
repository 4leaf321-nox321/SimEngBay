...
export const DEFAULT_APP_NAME = 'SimEngBay'
export const DEFAULT_APP_SLUG = 'simengbay'
export const DEFAULT_APP_TAGLINE = 'Simulation Engineering Bay'
