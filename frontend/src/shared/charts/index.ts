 ...
 *     Spectrum   가로축이 **수치**인 줄기 그림 — 주파수 스펙트럼처럼 「값 자리」 가 뜻을 갖는 것
...
export { Spectrum } from '@/shared/charts/Spectrum'
export type { SpectrumLine, SpectrumPoint, SpectrumProps } from '@/shared/charts/Spectrum'
